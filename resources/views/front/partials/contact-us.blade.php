        ...
        <div class="row">
            <div class="col-lg-8">
                <div id="map">
                    ...
                    <iframe
                        src="{{ url("https://maps.google.com/maps?q=".$contact[0]->adresse."&t=&z=18&ie=UTF8&iwloc=&output=embed") }}"
            ...
            <div class="col-lg-12">
                <p class="copyright">Copyright © 2022 EduWell Co., Ltd. All Rights Reserved.
                    ...
                    <br>Design: <a rel="sponsored" href="{{ url('https://templatemo.com') }" target="_blank">TemplateMo</a>
                </p>
            </div>
        </div>
    </div>
